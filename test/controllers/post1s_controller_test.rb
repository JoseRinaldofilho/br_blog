...
class Post1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post1" do
    assert_difference('Post1.count') do
      post post1s_url, params: { post1: { descricao: @post1.descricao, titulo: @post1.titulo } }
    end
  ...
  test "should update post1" do
    patch post1_url(@post1), params: { post1: { descricao: @post1.descricao, titulo: @post1.titulo } }
